...
julie = User.new(first_name: "Julie", last_name: "THOMAS", admin: false)
...
clementine = User.new(first_name: "Clementine", last_name: "DELTHE", admin: false)
...
nicolas = User.new(first_name: "Nicolas", last_name: "RIERA", admin: false)
...
djessy = User.new(first_name: "Djessy", last_name: "COIFFE", admin: false)
...
timbaland = User.new(first_name: "Tim", last_name: "BALAND", admin: true)
...
drdre = User.new(first_name: "Dr", last_name: "DRE", admin: true)
...
jayz = User.new(first_name: "Jay", last_name: "Z", admin: true)
...
pitbull = Artist.new(name: "Pitbull", category: "Rnb", price: 70000, description: "Pitbull, également appelé Mr. Worldwide, ou encore Mr. 305, de son vrai nom Armando Christian Pérez, né le 15 janvier 1981 à Miami, est un rappeur, producteur, acteur et entrepreneur américain d’origine cubaine.", user: timbaland)
...
florida = Artist.new(name: "Florida", category: "Rnb", price: 65000, description: "Flo Rida, de son vrai nom Tramar Lacel Dillard, né le 16 septembre 1979 à Opa-locka, en Floride, est un rappeur américain. Son nom vient du nom de l’État de Floride. Ancien basketteur à l’université, il est remarqué par le label Poe Boy Entertainment basé à Miami, dans lequel il s’est engagé.", user: drdre)
...
anastacia = Artist.new(name: "Anastasia", category: "Pop", price: 45000, description: "Anastacia Lyn Newkirk, née le 17 septembre 1968 à Chicago, est une chanteuse de pop, soul et d’influence rock.", user: jayz)
...
usher = Artist.new(name: "Usher", category: "Rnb", price: 62000, description: "Usher, de son nom complet Usher Raymond IV, né le 14 octobre 1978 à Dallas, au Texas, est un chanteur de RnB, danseur, parolier et acteur américain.", user: drdre)
...
aventura = Artist.new(name: "Aventura", category: "Latino", price: 25000, description: "Aventura est un groupe de bachata qui chante en espagnol ou en spanglish, formé en 1994 dans le Bronx de New York. Le groupe connaît un grand succès en 2002 avec la chanson Obsesión.", user: drdre)
aventura.photo.attach(io: aventura_photo, filename: "aventura.png", content_type: "image/png")
aventura.save

puts "Creating bookings..."
Booking.new(user: timbaland, artist: florida, date: (Date.today + 45), validated: true)
Booking.new(user: timbaland, artist: britney_spears, date: (Date.today + 22), validated: true)
